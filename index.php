<!DOCTYPE html>
  <html>
    <head>  
      ...
      <title>Lynn Garfield : Home</title>
      ...
      <link id="switcher" href="css/themes/lynn-theme.css" type="text/css" rel="stylesheet" media="screen,projection"/>     
       <!-- Main css File -->
          ...
          <nav>
            <div class="container">
              <div class="nav-wrapper">
                ...
                <!-- TEXT BASED LOGO -->
                <a href="index.html" class="brand-logo">LA Garfield</a>
                ...
                <div class="row">
                  <div class="col s12">
                    <div class="home-inner">
                      <h1 class="home-title">Hello! I'm <span>Lynn Garfield</span></h1>
                      <p>I'm a USA based Full Stack Web Developer Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam in reprehenderit facere mollitia, veritatis libero nulla minima, quisquam amet laboriosam voluptatum. </p>
                    ...
                    <div class="row">
                      <div class="col s12 m4 l3">
                        <div class="about-inner-left">
                          <img class="profile-img" src="img/profile-img.jpeg" alt="Profile Image">
                        </div>
                      </div>
                      <div class="col s12 m8 l9">
                        <div class="about-inner-right">
                          <h3>About Me</h3>
                          <p>I'm a USA Full Stack Web Developer creating awesome and effective visual identities for companies of all sizes around the globe.It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here</p>
                          <div class="personal-information col s12 m12 l6">
                            <h3>Personal Information</h3>
                            <ul>
                              <li><span>Name : </span>Lynn Garfield </li>
                               <li><span>Phone : </span>(309) 621-5307</li>
                              <li><span>Email : </span>lynngarfield13@gmail.com</li>
                              <li><span>Address : </span>Allen, Texas</li>
                            </ul>
                          </div>
                ...
                <div class="education-inner">
                  ...
                  <div id="owl-carousel1" class="experience-slider row">
                    ...
                    <div class="col s12">
                      <div class="card">
                        <div class="card-image waves-effect waves-block waves-light">
                        <h2 class="experience-title">2020 - 2021</h2>
                          <img class="activator" src="img/graduate-cap.jpg">
                        </div>
                        <div class="card-content">
                          <span class="card-title activator reveal-title">Full Stack Web Developer Certificate<i class="material-icons right">more_vert</i></span>
                          <p><a href="#">Collin College - Web & Mobile Development - Frisco, Texas</a></p>
                        </div>
                        <div class="card-reveal">
                          <span class="card-title reveal-title">Full Stack Web Developers Certificate<i class="material-icons right">close</i></span>
                          <a href="#" class="card-subtitle">Collin College - Web & Mobile Development - Frisco, Texas</a>
                          <p>Here is some more information about this product that is only revealed once clicked on.
                          The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English</p>
                        </div>
                      </div>
                    ...
                    <div class="col s12">
                      <div class="card">
                        ...
                        <div class="card-content">
                          <span class="card-title activator reveal-title">Mobile Application Developer Certificate<i class="material-icons right">more_vert</i></span>
                          <p><a href="#">Collin College - Web & Mobile Development - Frisco, Texas</a></p>
                        </div>
                        <div class="card-reveal">
                          <span class="card-title reveal-title">Mobile Application Developer Certificate<i class="material-icons right">close</i></span>
                          <a href="#" class="card-subtitle">Collin College - Web & Mobile Development - Frisco, Texas</a>
                          <p>Here is some more information about this product that is only revealed once clicked on.
                          </p>
                        </div>
                    ...
                    <div class="col s12">
                      <div class="card">
                        ...
                        <div class="card-content">
                          <span class="card-title activator reveal-title">JavaScript Development Certificate<i class="material-icons right">more_vert</i></span>
                          <p><a href="#">Collin College - Web & Mobile Development - Frisco, Texas</a></p>
                        </div>
                        <div class="card-reveal">
                          <span class="card-title reveal-title">JavaScript Development Certificate<i class="material-icons right">close</i></span>
                          <a href="#" class="card-subtitle">Collin College - Web & Mobile Development - Frisco, Texas</a>
                          <p>Here is some more information about this product that is only revealed once clicked on.
                          The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English</p>
                        </div>
                    ...
                    <div class="col s12">
                      <div class="card">
                        <div class="card-image waves-effect waves-block waves-light">
                        <h2 class="experience-title">1984 - 1988</h2>
                          <img class="activator" src="img/graduate-cap.jpg">
                        </div>
                        <div class="card-content">
                          <span class="card-title activator reveal-title">Bachelor of Science in Computer Science<i class="material-icons right">more_vert</i></span>
                          <p><a href="#">The University of Iowa - Iowa City, Iowa</a></p>
                        </div>
                        <div class="card-reveal">
                          <span class="card-title reveal-title">Bachelor of Science<i class="material-icons right">close</i></span>
                          <a href="#" class="card-subtitle">The University of Iowa - Iowa City, Iowa</a>
                          <p>Here is some more information about this product that is only revealed once clicked on.
                          The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English</p>
                        </div>
                      </div>
                    ...
                    <div class="col s12">
                      <div class="card">
                        ...
                        <div class="card-content">
                          <span class="card-title activator reveal-title">Minor in Business Administration<i class="material-icons right">more_vert</i></span>
                          <p><a href="#">The Univeristy of Iowa - Iowa City, Iowa</a></p>
                        </div>
                        <div class="card-reveal">
                          <span class="card-title reveal-title">Minor in Business Administration<i class="material-icons right">close</i></span>
                          <a href="#" class="card-subtitle">The University of Iowa - Iowa City, Iowa</a>
                          <p>Here is some more information about this product that is only revealed once clicked on.
                          The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English</p>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col s12 m6 l6">
                            <div class="contact-map">
                              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d213875.06437952654!2d-96.81277515215295!3d33.11439716767218!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x864c172e4d9479bd%3A0xcae82aa992de2cd5!2sAllen%2C%20TX!5e0!3m2!1sen!2sus!4v1615910013784!5m2!1sen!2sus"  height="500" width="625" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
